...
public class Ant {
	...
	private double[] smellPheromone() // returns probabilities (0..1) for
										// following position based on pheromone
	{
	...
	private double[] accumulatedSum(double[] array) // *transforms* probability
													// array into accumulated
													// sum
	{
		double sum = 0;
	...
	private int chooseRandomIndex(double[] array) // chooses a index based on
